...
sentiment_predict('개맛있다 ㅋㅋㅋ')
sentiment_predict('또 시겨먹어야지')
sentiment_predict('최고다')

sentiment_predict('이딴게 음식이냐 ㅉㅉ')
sentiment_predict('절대 안시켜먹어야지')
sentiment_predict('최악이다 ㅉㅉ')
#
# #토큰화 파일 저장
